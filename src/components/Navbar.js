    ...
    height="35" alt="CoolBrand" marginTop="10px" />
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav">
                ...
                <a href="#" className="nav-item nav-link">Shelters&nbsp;<img src={shelter} height="20"/></a>
                <a href="#" className="nav-item nav-link">About&nbsp;<img src={about} height="15"/></a>
            </div>
            <div className="navbar-nav ml-auto">
                <a href="#" className="nav-item nav-link">Register&nbsp;<img src={register} height="15"/></a>
                <a href="#" className="nav-item nav-link">Login&nbsp;<img src={login} height="14"/></a>
            </div>
        </div>
    </nav>
  )}