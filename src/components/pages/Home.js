    ...
    return (
      ...
      {data => {
       return <div className="col-sm-6 col-md-4 col-lg-3 mt-4">
          <div style = { card }>
              <img style={{ display: 'block', width: '100%', height: 'auto' }} src="https://cdn.pixabay.com/photo/2016/02/19/15/46/labrador-retriever-1210559__340.jpg"/>
              <div style={ cardblock }>
                  <figure style = { profile } >
                    <img src={heart} style = {{display: 'block', width: '100%', height: '100%', borderRadius: '50%'}} alt=""/>
                  </figure>
                  <h4 className="mt-3" style={{fontSize: '1.28571429em', fontWeight: '700', lineHeight: '1.2857em'}}>dog: 6 years old</h4>
                  <div style={ meta }>
                      <a>traits</a>
                  </div>
                <div style= {{clear: 'both', marginTop: '.5em', color: 'rgba(0, 0, 0, .68)'}}>
                      Dogname bla bla bla bla bla 
                  </div>
              </div>
